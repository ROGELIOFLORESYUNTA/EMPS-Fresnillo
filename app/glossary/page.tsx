...
const TERMS: Array<{ term: string; category: string; definition: string; source?: string }> = [
  ...
  { term: "Salario mínimo general 2026", category: "Laboral", definition: "$315.04 diarios ($9,577.22 mensuales, es decir el diario por 30.4 días, la misma convención que usa la UMA mensual). Aumento del 13% sobre 2025. Vigente desde el 1 de enero de 2026.", source: "CONASAMI - DOF 09-dic-2025" },
