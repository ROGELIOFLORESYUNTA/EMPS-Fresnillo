    ...
    <div className="space-y-6">
      ...
      <Card className="bg-muted/30">
        <CardContent className="py-4 text-sm text-muted-foreground">
          ...
          <Link href="/investigacion/modelos-ml" className="text-primary hover:underline">modelos ML</Link>) para calibrar el sistema. Las importaciones se registran manualmente; la carga real del archivo se hace fuera del sistema y se reporta aquí solo el resumen.
        </CardContent>
      </Card>
    </div>
  );
